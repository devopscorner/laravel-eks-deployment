...
ENV IMG_NAME="phpfpm"
ENV IMG_VERSION="8.1"
ENV IMG_DESC="Docker Image Alpine PHP-Fpm 8.1"
...
COPY compose/docker/phpfpm/8.1-fpm/php-fpm.tmpl.conf /var/data/php-fpm/php-fpm.tmpl.conf
COPY compose/docker/phpfpm/8.1-fpm/www.tmpl.conf /var/data/php-fpm/www.tmpl.conf
COPY compose/docker/phpfpm/8.1-fpm/php.tmpl.ini /var/data/php-fpm/default-php.tmpl.ini
...
# Copy util scripts
COPY compose/docker/phpfpm/8.1-fpm/envsubst.sh /envsubst.sh
COPY compose/docker/phpfpm/8.1-fpm/entrypoint.sh /entrypoint.sh
